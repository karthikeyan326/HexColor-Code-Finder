...
def showimage():
    ...
    Ibl.configure(image=img,width=310,height=270)
    Ibl.image=img
...
def Findcolor():
    ...
    colors2.itemconfig(id9, fill=color8)
...
image_icon=PhotoImage(file="images color\icon.png")
...
logo=PhotoImage(file="images color\logo.png")
